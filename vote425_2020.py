...
def browse():
    ...
    try:
        ...
        registerButton = browser.find_element_by_xpath("//html/body/main/div/div[1]/div/div/section[5]/div/div/div/div/div/section/div/div/div[2]/div/div/div/div/div/a")
        registerButton.click()

        cred = get_credential()
        textbox_user = browser.find_element_by_xpath(
            "//html/body/main/div/div[1]/div/div/section[3]/div/div/div/div/div/div/div/div/div/form/div[1]/div[1]/input")
        textbox_email = browser.find_element_by_xpath(
            "//html/body/main/div/div[1]/div/div/section[3]/div/div/div/div/div/div/div/div/div/form/div[1]/div[2]/input")
        textbox_pass = browser.find_element_by_xpath(
            "//html/body/main/div/div[1]/div/div/section[3]/div/div/div/div/div/div/div/div/div/form/div[1]/div[3]/div/div[1]/input")
        textbox_pass2 = browser.find_element_by_xpath(
            "//html/body/main/div/div[1]/div/div/section[3]/div/div/div/div/div/div/div/div/div/form/div[1]/div[3]/div/div[2]/input")
